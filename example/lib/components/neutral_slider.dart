...
class NeutralSlider extends StatefulWidget {
  const NeutralSlider({super.key});

  @override
  State<NeutralSlider> createState() => _NeutralSliderState();
}

class _NeutralSliderState extends State<NeutralSlider> {
